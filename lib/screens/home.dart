...
class HomeScreen extends StatelessWidget {
  ...
  /// от `devicePixelRatio`, а у BZ5 это число БЫЛО выведено из
  /// отношения 1920/2175 и оказалось неверным: экспорт 26.08 привёз замер
  /// 1280 x 656 dp при dpr 1.5, то есть отношение 1920/1280 — та же
  /// плотность, что у BZ3 (1080/720 = 1.5). Вывод ошибся, замер закрыл спор.

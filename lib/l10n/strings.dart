...
class S {
  ...
  static const Map<String, String> _en = {
    ...
    'atlas.tap_for_detail': 'tap a cell for details',
    'dash.insulation': 'INSULATION',
    'dash.insul_normal': 'normal for this car',
    'dash.insul_watch': 'below usual — worth a look',
    'dash.insul_alarm': 'low — have it checked',
    'dash.insul_charging': 'charging — dip is normal',
    'dash.insul_learning': 'learning what is normal',
    ...
    'trends.coverage_fmt': 'odometer {x} km · trips {y} km ({z}%)',
    ...
    'status.issue.line': 'Code {id} · {time}',
    'status.issue.color': 'severity {c}',
  ...
  static const Map<String, String> _ru = {
    ...
    'atlas.tap_for_detail': 'нажмите на клетку для подробностей',
    'dash.insulation': 'ИЗОЛЯЦИЯ',
    'dash.insul_normal': 'обычно для этой машины',
    'dash.insul_watch': 'ниже обычного, стоит присмотреться',
    'dash.insul_alarm': 'низко, показать специалисту',
    'dash.insul_charging': 'на зарядке просадка обычна',
    'dash.insul_learning': 'копим, что для неё обычно',
    ...
    'trends.coverage_fmt': 'одометр {x} км · записано {y} км ({z}%)',
    ...
    'status.issue.line': 'Код {id} · {time}',
    'status.issue.color': 'уровень {c}',
